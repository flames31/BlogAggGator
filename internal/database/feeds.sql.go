...
SELECT f.id, f.created_at, f.updated_at, f.name, url, user_id, last_fetched_at, u.id, u.created_at, u.updated_at, u.name FROM feeds f, users u WHERE f.user_id = u.id AND f.user_id = $1
`
